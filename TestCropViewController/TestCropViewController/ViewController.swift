...
//        cropController.title = "Crop Avatar"
        ...
        if croppingStyle == .circular {
            let cropNavigationController = UINavigationController()
            cropNavigationController.setViewControllers([cropController], animated: false)
            picker.dismiss(animated: true) {
                self.present(cropNavigationController, animated: true, completion: nil)
            }
        }
    ...
    public func updateImageViewWithImage(_ image: UIImage, fromCropViewController cropViewController: TOCropViewController) {
        ...
        if cropViewController.croppingStyle != .circular {
            ...
            cropViewController.dismissAnimatedFrom(self, toView: imageView, toFrame: CGRect.zero, setup: { self.layoutImageView() }, completion: { self.imageView.isHidden = false })
        }
        else {
